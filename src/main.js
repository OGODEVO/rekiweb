  ...
  <main>
    <section class="hero wrap" aria-labelledby="hero-title">
      <div class="hero-copy">
        ...
        <p class="hero-offer">Free in this browser. <strong>$15/month</strong> plus tax to keep it in your account.</p>
    ...
    <section class="faq wrap" aria-labelledby="faq-title"><div><span class="eyebrow">A FEW LITTLE DETAILS</span><h2 id="faq-title">Good to know.</h2></div><div class="faq-items">
      ...
      <details><summary>Do I need a card to try it?<span>+</span></summary><p>No — the preview is free, no account or card needed. Membership is separate: $15/month plus tax through Whop. Renews until canceled; cancel in Whop.</p></details>
...
async function initPaidAccess() {
  ...
  if (note && paidAccess.checkoutUrl)
    note.textContent =
      "Secure checkout via Whop. $15/month plus tax.";
  else if (note)
    note.textContent =
      "Checkout is unavailable in this session. The free preview still works.";
  const me = await paidFetch("/api/me?refresh=1");
