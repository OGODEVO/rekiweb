  ...
  <main>
    <section class="hero wrap" aria-labelledby="hero-title">
      <div class="hero-copy">
        ...
        <p class="hero-description">Your stack, check-offs, and feeling log — one calm page.<br>Add one supplement and feel how it works.</p>
        <p class="hero-offer">Free in this browser. <strong>$4.99/month</strong> plus tax to keep it in your account.</p>
        ...
        <div class="hero-footnote">${icon("check")} Not another PDF. A place that remembers.</div>
    ...
    <section id="how-it-works" class="routine wrap" aria-labelledby="routine-title">
      <div class="section-heading"><div><span class="eyebrow">LESS GUESSING. MORE NOTICING.</span><h2 id="routine-title">A routine that fits<br>real life.</h2></div><p>No dashboard. Just a little space that remembers.</p></div>
      <div class="routine-steps">
        <article><div class="step-number">01 <span></span></div><div class="step-art stack-art"><div>${icon("leaf")} Your everyday essentials</div><div>${icon("plus")} Room for your own routine</div></div><h3>Give your stack a home.</h3><p>Add what you take. Schedule and notes, no spreadsheet.</p></article>
        <article><div class="step-number">02 <span></span></div><div class="step-art tick-art"><span>${icon("check")}</span><p>One little check.<br><strong>One less thing to remember.</strong></p></div><h3>Check in, then get on.</h3><p>Open Today, check it off, get on with your day.</p></article>
        <article><div class="step-number">03 <span></span></div><div class="step-art feeling-art"><span>1</span><span>2</span><span>3</span><span class="chosen">4</span><span>5</span></div><h3>Notice how you feel.</h3><p>Log energy, sleep, mood. Your record — not a promise anything works.</p></article>
      </div>
    </section>
    <section id="membership-difference" class="comparison wrap" aria-labelledby="comparison-title">
      ...
      <table><caption class="sr-only">Free preview and Reki Web membership comparison</caption><thead><tr><th scope="col">What you get</th><th scope="col">Free preview</th><th scope="col">Member</th></tr></thead><tbody>
        ...
        <tr><th scope="row">Open your saved record on another device</th><td>Not included</td><td>Sign in with the email you paid with</td></tr>
      ...
      <p class="comparison-note">Same tracker and Insights in both. Membership adds account saving — not advice, results, AI scanning, or iPhone Pro. Saving needs internet.</p>
    </section>
    <section id="pricing" class="pricing wrap" aria-labelledby="price-title">
      <div class="price-story"><span class="eyebrow">YOUR ROUTINE, BEYOND ONE BROWSER</span><h2 id="price-title">Keep your record.<br>Wherever you log in.</h2><p>Start on your laptop. Open it on your phone.<br>$4.99/month plus tax. Follows your Whop account.</p><img class="waving-reki" src="/assets/reki-waving.webp" alt="Reki smiling and waving" width="480" height="1014" loading="lazy"><span class="mascot-signature">see you tomorrow.</span></div>
      <div class="price-card"><span class="offer-label">REKI WEB · MONTHLY MEMBERSHIP</span><div class="price"><span class="currency">$</span>4.99<span class="price-period">USD<br>per month</span></div><p class="price-subtitle">$4.99 USD per month, plus applicable tax. Renews automatically until canceled. Cancel anytime in Whop.</p><ul><li>${icon("check")} Account-backed stack, check-offs & feel logs</li><li>${icon("check")} Load your saved record on another device</li><li>${icon("check")} Recover your last save after clearing browser data</li><li>${icon("check")} Read & export saved data after access ends</li></ul><button class="button button-dark price-button" id="beta-button" aria-describedby="checkout-status billing-disclosure">Start my membership — $4.99/month ${icon("arrow")}</button><p class="checkout-note" id="checkout-status" role="status" aria-live="polite">Checking membership and checkout availability...</p><p class="terms-note" id="billing-disclosure">$4.99 USD per month. Tax added at checkout; Whop shows the renewal date. Cancel in Whop; keep paid time. No AI scanning or iPhone Pro.</p></div>
    </section>
    <section class="after-join wrap" aria-labelledby="after-join-title"><img src="/assets/reki-face.webp" alt="" width="56" height="56"><div><h3 id="after-join-title">After you join</h3><ol><li><strong>Pay on Whop.</strong> Check the total and renewal.</li><li><strong>Come back here.</strong> Checkout returns you.</li><li><strong>Sign in with your email.</strong> Use the same email you paid with.</li></ol><p>Already active? The button opens your tracker, not another checkout. Interrupted? Come back and Sign in.</p></div></section>
    <section class="faq wrap" aria-labelledby="faq-title"><div><span class="eyebrow">A FEW LITTLE DETAILS</span><h2 id="faq-title">Good to know.</h2></div><div class="faq-items">
      <details><summary>Is this the Reki iPhone app?<span>+</span></summary><p>No. Reki Web is separate. It doesn't unlock Reki Pro or iPhone features.</p></details>
      <details><summary>What does this preview save?<span>+</span></summary><p>Everything stays in this browser. No account, backup, or sync. Clearing browser data erases it — avoid shared devices for personal stuff.</p></details>
      <details><summary>Can it tell me if my supplements work?<span>+</span></summary><p>No. It records routine and feelings over time. Self-reported patterns prove nothing about cause. Not medical advice.</p></details>
      <details><summary>Do I need a card to try it?<span>+</span></summary><p>No — the preview is free, no account or card needed. Membership is separate: $4.99/month plus tax through Whop. Renews until canceled; cancel in Whop.</p></details>
      <details><summary>What if it isn't useful for me?<span>+</span></summary><p>Test the routine free first — no purchase needed. Membership pays for account saving, not health promises. Cancel renewals in Whop; check refund terms at checkout.</p></details>
      <details><summary>Is my data private?<span>+</span></summary><p>Preview stays in this browser. Member records live on our server for your signed-in account. Whop handles payment; sign-in is our email link. Tracker content never goes to Whop. <a href="/legal.html#privacy">Details</a>.</p></details>
      <details><summary>How do I sign in?<span>+</span></summary><p>Enter your email, get a one-time link. No password, no Whop login. Use the email you paid with.</p></details>
      <details><summary>How do I cancel?<span>+</span></summary><p>In the Whop account you paid with, before next renewal. Cancel stops renewals; it is not a refund. Read checkout terms. Help: admin@rekisupplement.org.</p></details>
    </div></section>
  </main>
...
function showExpiredBanner() {
  ...
  banner.innerHTML =
    ...
    `<div class="banner-actions"><a class="button button-small button-coral" href="#pricing">Renew — $4.99</a>` +
...
function updatePriceCardRenew() {
  ...
  const note = document.querySelector(".checkout-note");
  if (button) {
    button.innerHTML = `Renew membership — $4.99 ${icon("arrow")}`;
  }
  if (note) {
...
async function initPaidAccess() {
  ...
  if (note && paidAccess.checkoutUrl)
    note.textContent =
      "Secure checkout via Whop. $4.99/month plus tax.";
  else if (note)
    note.textContent =
      "Checkout is unavailable in this session. The free preview still works.";
  const me = await paidFetch("/api/me?refresh=1");
...
window.addEventListener("pageshow", (event) => {
  ...
  button.disabled = false;
  button.removeAttribute("aria-busy");
  button.innerHTML = `Start my membership — $4.99/month ${icon("arrow")}`;
  void initPaidAccess();
});
